...
var me = "style[".concat(f, "][").concat("data-styled-version", '="').concat("6.0.0-rc.5", '"]');
...
var we = function(e) {
  ...
  o2.setAttribute(f, "active"), o2.setAttribute("data-styled-version", "6.0.0-rc.5");
  var i2 = Se();
...
function Qe(e, r2, s2) {
  var i2 = ee(e), a2 = e, c2 = !M(e), p2 = r2.attrs, d = void 0 === p2 ? E : p2, h = r2.componentId, f2 = void 0 === h ? function(e2, t) {
    ...
    Ze[n] = (Ze[n] || 0) + 1;
    var o2 = "".concat(n, "-").concat(x("6.0.0-rc.5" + n + Ze[n]));
...
var ut = function() {
  function e() {
    ...
    this._emitSheetCSS = function() {
      var t = e2.instance.toString(), n = Se(), o2 = ne([n && 'nonce="'.concat(n, '"'), "".concat(f, '="true"'), "".concat("data-styled-version", '="').concat("6.0.0-rc.5", '"')].filter(Boolean), " ");
      ...
      if (e2.sealed)
        throw ce(2);
      var r2 = ((n = {})[f] = "", n["data-styled-version"] = "6.0.0-rc.5", n.dangerouslySetInnerHTML = { __html: e2.instance.toString() }, n), s2 = Se();
